        ...
        while not self.stop_event.is_set():
            try:
                ...
                if file_found:
                    ...
                    if elapsed_time > 120:
                        print(f"\033[1;31m[ Shouko.dev ] - {self.package_name}: Executor crash detected (No signal for 120s). Restarting...\033[0m")
                        ...
                        status_msg = f"\033[1;33mNo signal: {int(elapsed_time)}s/120s\033[0m"
                        if not self.is_first_load:
                            status_msg = f"\033[1;33mExecutor Idle/Crash? {int(elapsed_time)}s/120s\033[0m"
