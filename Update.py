...
roblox_clients = [f"com.roblox.client{i}" for i in range(0, 10)]
par_run(clear_package, [(pkg,) for pkg in roblox_clients], max_workers=9)
par_run(uninstall_package, [(pkg,) for pkg in roblox_clients], max_workers=9)
par_run(clear_package, [(pkg,) for pkg in roblox_clients], max_workers=9)
print(SUCCESS + "🍲 Cleared And Uninstalled! 🍛")
print(TITLE + "🎯 Installing 9 Tabs... 🍵")
