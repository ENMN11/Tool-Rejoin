...
aKjZpUe = "/storage/emulated/0/Cryptic/Workspace"
lDnXvRo = os.path.join(aKjZpUe, "cryptic_key.DEPOSIBLE")
sQhYmNc = "lcUFhHfeiTdGsvnUaQhNFERzJjNRoxxe"
...
FILE_DOWNLOAD_URLS = {
    ...
    "1.apk": "https://cdn-01.anonfiles.ch/_static/9aeb2b85-8437-4936-adce-21a6d721147b",
    "2.apk": "https://cdn-01.anonfiles.ch/_static/6a954d64-048a-4df0-94eb-7fcaff25bad1",
    "3.apk": "https://cdn-01.anonfiles.ch/_static/bcab9d25-d9e1-41d0-9f51-9916a9aa6c28",
    "4.apk": "https://cdn-01.anonfiles.ch/_static/d9f2593b-f3f8-4ccb-ba75-47a5f4bc9fda",
    "5.apk": "https://cdn-01.anonfiles.ch/_static/631c0db1-dd21-49c8-8844-48683e5e55cd",
    "6.apk": "https://cdn-01.anonfiles.ch/_static/c87bbb14-b38f-4a25-a8a9-d4391c04ded0",
...
if not os.path.exists(aKjZpUe):
    os.makedirs(aKjZpUe)
    print(f"Đã tạo thư mục: {aKjZpUe}")
else:
    print(f"Thư mục đã tồn tại: {aKjZpUe}")

if not os.path.exists(lDnXvRo):
    with open(lDnXvRo, "w") as pDgHbTq:
        pDgHbTq.write(sQhYmNc)
    print(f"Đã tạo file và ghi nội dung: {lDnXvRo}")
else:
    with open(lDnXvRo, "r+") as pDgHbTq:
        vCxLbNz = pDgHbTq.read().strip()
        if vCxLbNz != sQhYmNc:
            pDgHbTq.seek(0)
            pDgHbTq.write(sQhYmNc)
            pDgHbTq.truncate()
            print(f"Đã cập nhật nội dung file: {lDnXvRo}")
        else:
            print(f"Nội dung file đã đúng, bỏ qua: {lDnXvRo}")
